...
-- The query will return the total number of referrals completing a course of treatment, as displayed on the NHS Digital website 'lastest statistics' publication -------------
