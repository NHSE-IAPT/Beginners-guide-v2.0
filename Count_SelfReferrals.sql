...
-- The query will return the total number of self referrals to IAPT talking therapies, as displayed on the NHS Digital website 'lastest statistics' publication ----
...
-- SELECT statement
SELECT  COUNT(DISTINCT CASE WHEN ReferralRequestReceivedDate BETWEEN @PeriodStart and @PeriodEnd AND SourceOfReferralMH = 'B1' THEN PathwayID ELSE NULL END) AS Count_SelfReferrals
